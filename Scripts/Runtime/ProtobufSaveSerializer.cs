...
namespace UGS.Save
{
    ...
    /// Protobuf存档序列化器
    /// </summary>
    public class ProtobufSaveSerializer : ISaveSerializer
    {
        /// <summary>
        /// 序列化对象为Protobuf字符串
        /// </summary>
        ...
        public string Serialize<T>(T data) where T : class
        {
            ...
            {
                Debug.LogError($"[ProtobufSaveSerializer] 序列化失败: {ex.Message}");
                throw;
            }
        }
        ...
        public T Deserialize<T>(string serializedData) where T : class
        {
            ...
            {
                Debug.LogError($"[ProtobufSaveSerializer] 反序列化失败: {ex.Message}");
                throw;
            }
        }
    }
